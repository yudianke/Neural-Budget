...
from offline_eval import EvalResults, SANITY_CASES, _compute_eval_results, _normalize_merchant
...
class TestComputeEvalResults:
    def test_perfect_predictions(self):
        ...
        result = _compute_eval_results(y_true, y_pred, le, "test", 0.5, "7", time.time())
